 ...
 * When a packet class is created (E.g. Packet00Connect), it will extend this class,
...
public abstract class Packet {
	 ...
	 * When a packet class is created, (E.g. Packet00Connect), it will get a type tag in order
