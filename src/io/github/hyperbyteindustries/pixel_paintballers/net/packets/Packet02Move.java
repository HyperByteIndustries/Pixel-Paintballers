...
/**
 * Represents the movement packet of the multiplayer system.
...
public class Packet02Move extends Packet {
	 ...
	 * @param varX - The velocity of the player across the x-axis if moving, else the x coordinate
	 * of the player.
	 * @param varY - The velocity of the player across the y-axis if moving, else the y coordinate
	 * of the player.
	 */
	public Packet02Move(String username, boolean moving, float varX, float varY) {
		super("02");
